...
title = health_monitor_kivy


# (str) Package name
package.name = health_monitor_kivy


# (str) Package domain (needed for android/ios packaging)
package.domain = org.eren
...
source.exclude_dirs = tests, bin, venv, .venv, __pycache__, .git, .vscode, .buildozer
...
requirements = python3,sqlite3,kivy
